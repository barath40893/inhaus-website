...
const ProductDetailPage = () => {
  ...
  const products = {
    ...
    'glass-touch-switch': {
      id: 'glass-touch-switch',
      name: 'Full Glass Touch Switch',
      price: 6499,
      originalPrice: 7999,
      rating: 4.9,
      reviews: 98,
      inStock: true,
      images: [
        'https://customer-assets.emergentagent.com/job_inhaus-ecommerce/artifacts/pg4qh7gu_glassswitch-CK9TAW1I.jpg',
      ],
